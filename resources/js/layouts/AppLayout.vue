...
<template>
    ...
    <nav class="fixed top-0 z-50 w-full border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
        <div class="flex h-10 w-full items-center justify-between bg-primary-500 px-4 text-white" v-if="auth().is_impersonating">
            <div></div>
                        ...
                        <template #content>
                            <div class="flex flex-col items-center justify-center p-4 pb-2" @click="disableHide">
                                <div class="group relative size-20 overflow-hidden rounded-full">
                                    ...
                                    <label
                                        class="absolute right-0 top-0 flex size-full cursor-pointer items-center justify-center bg-black bg-opacity-50 opacity-0 duration-150 group-hover:opacity-100"
                                    >
    ...
    <div class="min-h-[calc(100vh-65px)] bg-white p-4 lg:ml-64 lg:mt-0">
